...
const class5Chapter9 = {
    reading: [
        ...
        },
        {
            ...
            answer: "Currency is the system of money used in a country, like rupees in India and dollars in the USA."
        },
        {
        ...
        },
        {
            ...
            answer: "Addition of money is done like normal numbers, keeping rupees and paise in separate columns."
        },
        {
            question: "What is subtraction of money?",
            answer: "Subtraction of money is done like normal subtraction, keeping rupees and paise in separate columns."
        },
        {
        ...
        },
        {
            ...
            answer: "Simple interest is the extra money paid for borrowing money, calculated using the formula SI = (P × R × T)/100."
        },
        {
            question: "What does P stand for in the simple interest formula?",
            answer: "In the SI formula, P stands for Principal, the money borrowed or invested."
        },
        {
            question: "What does R stand for in the simple interest formula?",
            answer: "R stands for Rate of interest, expressed in percentage per year."
        },
        {
        ...
        },
        {
            ...
            answer: "Profit is the extra money gained when selling price (SP) is more than cost price (CP)."
        },
        {
            question: "What is loss?",
            answer: "Loss is the money lost when cost price (CP) is more than selling price (SP)."
        },
        {
    ...
    test: [
        ...
        },
        {
            ...
            options: ["(P × R)/T", "(P × R × T)/100", "(P + R + T)/100", "None of these"],
            correct: 1
        },
        {
