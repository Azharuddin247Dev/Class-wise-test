...
const class7Chapter7 = {
  reading: [
    {
      ...
      answer:
        "Two triangles are congruent if they have exactly the same size and shape, i.e., corresponding sides and angles are equal.",
    },
    {
      question: "What is the importance of congruence?",
      answer:
        "Congruence helps in proving geometric properties and solving problems involving triangles.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "RHS (Right angle-Hypotenuse-Side): In right-angled triangles, if the hypotenuse and one side of one triangle are equal to the hypotenuse and one side of another triangle, they are congruent.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Measure all three sides of both triangles and compare. If all sides are equal, triangles are congruent.",
    },
    {
      question: "How do you show two triangles are congruent using SAS?",
      answer:
        "Measure two sides and the included angle of both triangles. If equal, triangles are congruent.",
    },
    {
      question: "How do you show two triangles are congruent using ASA?",
      answer:
        "Measure two angles and the included side of both triangles. If equal, triangles are congruent.",
    },
    {
      question:
        "How do you show two right-angled triangles are congruent using RHS?",
      answer:
        "Check the hypotenuse and one side of both triangles. If equal, triangles are congruent.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No, at least three sides or two sides with an included angle must be equal.",
    },
    {
      question:
        "Can two triangles be congruent if only two angles and one side are equal?",
      answer: "Yes, using ASA criterion.",
    },
    {
      question:
        "Can right-angled triangles be congruent using hypotenuse and side?",
      answer: "Yes, this is the RHS criterion.",
    },
    {
      question:
        "Why is it necessary to check the included angle in SAS and ASA?",
      answer:
        "Because the angle included between the sides ensures the shape matches exactly; otherwise, the triangles may not be congruent.",
    },
    {
      question:
        "What is a practical application of congruence in construction?",
      answer:
        "Ensures structural stability by using identical triangular components.",
    },
  ],
  ...
  broad: [
    {
      question:
        "Two triangles have sides 5 cm, 6 cm, 7 cm and 5 cm, 6 cm, 7 cm. Are they congruent?",
      answer: "Yes, by SSS criterion all corresponding sides are equal.",
    },
    {
      question:
        "Two triangles have sides 5 cm, 7 cm and included angle 60° equal. Are they congruent?",
      answer: "Yes, by SAS criterion.",
    },
    {
      question:
        "Two triangles have two angles 50° and 60° and included side 5 cm equal. Are they congruent?",
      answer: "Yes, by ASA criterion.",
    },
    {
      question:
        "Two right-angled triangles have hypotenuse 10 cm and one side 6 cm equal. Are they congruent?",
      answer: "Yes, by RHS criterion.",
    },
    {
      question: "If only two sides of triangles are equal, are they congruent?",
      answer: "No, the included angle must also be equal for SAS.",
    },
  ],
  ...
  test: [
    ...
    },
    {
      ...
      options: [
        "Any angle",
        "Angle included between two sides",
        "Opposite angle",
        "Right angle only",
      ],
      correct: 1,
