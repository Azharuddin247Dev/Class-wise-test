...
const class7Chapter4 = {
  reading: [
    {
      ...
      answer:
        "A simple equation is an equation where the variable appears only once and can be solved using basic arithmetic operations. Example: x + 5 = 12.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Transposition means moving a term from one side of the equation to the other by changing its sign. Example: x + 5 = 12 → x = 12 - 5.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Substitute the value of the variable into the original equation to check if both sides are equal.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "It helps develop logical thinking and is useful in daily life problems like money, age, and measurements.",
    },
    {
      question: "How do you handle equations with variables on both sides?",
      answer:
        "Bring variable terms to one side and constants to the other, then solve normally.",
    },
    {
  ...
  broad: [
    {
      question: "Solve x + 9 = 20 using transposition method.",
      answer: "Subtract 9 from both sides: x = 20 - 9 → x = 11.",
    },
    {
      question: "Solve 4x = 28.",
      answer: "Divide both sides by 4: x = 28 ÷ 4 → x = 7.",
    },
    {
      question: "Solve x/6 = 5.",
      answer: "Multiply both sides by 6: x = 5 × 6 → x = 30.",
    },
    {
      question: "Solve 3x + 4 = 19.",
      answer: "Subtract 4: 3x = 15, divide by 3: x = 5.",
    },
    {
      question: "Solve 2x + 7 = x + 15.",
      answer: "Subtract x: x + 7 = 15, subtract 7: x = 8.",
    }
  ],
