    ...
    reading: [
        {
            ...
            answer: "A linear equation in one variable is an equation that can be written in the form ax + b = 0, where a ≠ 0."
        },
        {
        ...
        },
        {
            ...
            answer: "The variable is the letter that represents an unknown number, like x, y, or a."
        },
        {
            question: "How do you solve a linear equation?",
            answer: "Isolate the variable on one side using inverse operations to find its value."
        },
        {
            question: "Example: Solve 2x + 5 = 11.",
            answer: "2x + 5 = 11 → 2x = 11 - 5 → 2x = 6 → x = 3."
        },
        {
        ...
        },
        {
            ...
            answer: "Substitute the value of the variable into the original equation and verify both sides are equal."
        },
        {
            question: "What are like terms?",
            answer: "Terms having the same variable raised to the same power. Example: 3x and 5x are like terms."
        },
        {
        ...
        },
        {
            ...
            answer: "Transposition means moving a term from one side to the other by changing its sign."
        },
        {
            question: "Solve 3x - 7 = 8.",
            answer: "3x - 7 = 8 → 3x = 8 + 7 → 3x = 15 → x = 5."
        },
        {
            question: "Solve 5y + 2 = 12.",
            answer: "5y + 2 = 12 → 5y = 10 → y = 2."
        },
        {
            question: "Can linear equations have negative solutions?",
            answer: "Yes, depending on the constants and coefficients, the solution can be negative."
        },
        {
            question: "Solve -2x + 5 = 1.",
            answer: "-2x + 5 = 1 → -2x = -4 → x = 2."
        },
        {
            question: "Example of linear equation in real life?",
            answer: "If a mobile costs 2000 and you pay x rupees more to reach 3500, the equation is 2000 + x = 3500."
        },
        {
            question: "What is the importance of linear equations?",
            answer: "They are used to model real-life problems in finance, measurement, and everyday calculations."
        },
        {
            question: "How to handle fractions in linear equations?",
            answer: "Multiply both sides by the denominator to remove fractions before solving."
        },
        {
            question: "How to handle decimals in linear equations?",
            answer: "Multiply both sides by a power of 10 to convert decimals into whole numbers."
        },
        {
            question: "Solve 1/2 x + 3 = 7.",
            answer: "1/2 x + 3 = 7 → 1/2 x = 4 → x = 8."
        },
        {
            question: "Solve 0.5y - 2 = 3.",
            answer: "0.5y - 2 = 3 → 0.5y = 5 → y = 10."
        }
    ],
    test: [
        {
