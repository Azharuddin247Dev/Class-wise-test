// Class 6 - Chapter 10: Mensuration
const class6Chapter10 = {
  reading: [
    {
      question: "What is mensuration?",
      answer:
        "Mensuration is the branch of mathematics that deals with the measurement of length, area, and volume of different figures.",
    },
    {
      question: "What is perimeter?",
      answer: "Perimeter is the total distance around a closed figure.",
    },
    {
    ...
    {
      question:
        "Find the perimeter of a rectangle with length 10 cm and breadth 4 cm.",
      answer: "Perimeter = 2 × (length + breadth) = 2 × (10 + 4) = 28 cm.",
    },
    {
      question:
    ...
    },
    {
      ...
      answer: "Area = 1/2 × base × height = 1/2 × 6 × 8 = 24 cm².",
    },
    {
    ...
    {
      question:
        "Find the volume of a cuboid with length 10 cm, breadth 6 cm, and height 4 cm.",
      answer: "Volume = l × b × h = 10 × 6 × 4 = 240 cm³.",
    },
    {
      question:
        "What is the perimeter of an equilateral triangle with side 9 cm?",
      answer: "Perimeter = 3 × side = 3 × 9 = 27 cm.",
    },
    {
      question:
