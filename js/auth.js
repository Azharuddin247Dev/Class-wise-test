...
function logout() {
  ...
  // Add fade out animation to current container
  const activeContainer = document.querySelector('.container > div:not([style*="display: none"])');
  if (activeContainer) {
  ...
  setTimeout(() => {
    window.auth
      ...
      .then(() => {
        ...
        // Hide all screens and show auth with animation
